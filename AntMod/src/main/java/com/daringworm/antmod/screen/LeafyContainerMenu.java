...
public class LeafyContainerMenu extends AbstractContainerMenu {
    ...
    public LeafyContainerMenu(int pContainerId, Inventory inv, BlockEntity entity) {
        ...
        this.blockEntity.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY).ifPresent(handler -> {
            int yval = 37;
            this.addSlot(new SlotItemHandler(handler, 0, 8, yval));
            this.addSlot(new SlotItemHandler(handler, 1, 26, yval));
            this.addSlot(new SlotItemHandler(handler, 2, 44, yval));
            this.addSlot(new SlotItemHandler(handler, 3, 62, yval));
            this.addSlot(new SlotItemHandler(handler, 4, 80, yval));
            this.addSlot(new SlotItemHandler(handler, 5, 98, yval));
            this.addSlot(new SlotItemHandler(handler, 6, 116, yval));
            this.addSlot(new SlotItemHandler(handler, 7, 134, yval));
            this.addSlot(new SlotItemHandler(handler, 8, 152, yval));
        });
    }
